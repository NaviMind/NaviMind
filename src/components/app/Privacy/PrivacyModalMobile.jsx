...
export default function PrivacyModalMobile({ onClose }) {
  ...
  return (
   ...
   <div className="bg-white/95 dark:bg-gray-800/95 rounded-2xl shadow-2xl
      ...
      >
        ...
        <p>
          Used to keep you signed in, remember preferences, analyze traffic. Can
          be controlled in browser settings.
        </p>
      ...
      {/* Кнопка (активна только после доскролла) */}
